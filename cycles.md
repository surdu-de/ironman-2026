...
| Cycle | Weeks | Dates | Phase | Peak Long Bike | Status |
|-------|-------|-------|-------|----------------|--------|
...
| Zone | Name | Pace | Purpose |
|------|------|------|---------|
| T1 | Recovery | >2:42 | Warmup/cooldown |
| T2 | Aerobic | 2:27-2:42 | Technique, base |
| T3 | Tempo | 2:12-2:27 | Race pace |
| T4 | Threshold | 1:58-2:12 | Hard efforts |
| T5 | VO2max | <1:58 | Sprint intervals |

**CSS History:** 2:33/100m (baseline) -> 2:27/100m (Wk 4)

---

## Completed Cycles

### Cycle 1: Base Building (Weeks 1-4)

| Metric | Baseline | End | Change |
|--------|----------|-----|--------|
| FTP | 195W | 220W | +25W (+13%) |
...
### Cycle 2: Endurance Development (Weeks 5-8)
...
- Consistency through holiday period (Christmas/New Year)
- Smart self-coaching decisions (upgraded threshold work)

**Challenges:**
- Week 8 recovery violations (tempo during recovery week)
- Holiday disruptions affected schedule

---

### Cycle 3: Threshold Development (Weeks 9-12)
...
- Long bike peak: 4h03 / 125.6km
- Long run peak: 2h30 / 24.7km
- Mental toughness: 2h run in heavy snow

**Critical Learnings:**
1. **Weekly cap: 12h max** (Week 10's 15h40 caused Week 11 fatigue)
2. **2 swims/week max** (life constraint accepted)
3. **No extensions** when feeling good - bank energy
4. **Add anaerobic work** (deficit identified via Garmin)
5. **Use Garmin** for daily readiness, not rigid adherence

...
export function Header() {
    ...
    return (
      <header className="px-4 pt-6 pb-4 md:px-8 md:pt-10 2xl:px-16 2xl:pt-16">
        ...
        <div className="mt-1 flex flex-wrap items-end gap-x-6 gap-y-2">
          ...
          <p className="text-sm text-muted md:text-base 2xl:text-xl">
            Sunday, June 7, 2026
          </p>
        </div>
        <p className="mt-2 text-sm text-muted md:text-base 2xl:text-lg" data-testid="race-cause">
          Season complete · {result.cause}
        </p>
        <div className="mt-3 flex flex-wrap gap-x-6 gap-y-1 text-xs text-muted md:text-sm 2xl:text-base">
          <span>
            Result · Swim{' '}
  ...
  return (
    <header className="px-4 pt-6 pb-4 md:px-8 md:pt-10 2xl:px-16 2xl:pt-16">
      ...
      <p className="mt-2 text-sm text-muted md:text-base 2xl:text-lg" data-testid="current-week">
        Week {current.week} ·{' '}
      ...
      <div className="mt-3 flex flex-wrap gap-x-6 gap-y-1 text-xs text-muted md:text-sm 2xl:text-base">
        <span>
          ...
          <span className="text-text">{race.targets.total}</span>
        </span>
      </div>
    </header>
  )

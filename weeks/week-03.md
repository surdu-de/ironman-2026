...
##### Tue Nov 25
###### 🏃 Run (6:00-7:00)
**60min Threshold Intervals**
- 10min warmup (easy Z1-Z2)
- 5x4min @ Z4 threshold (91-95% HRmax)
  - 3min jog recovery between intervals
  - RPE 8/10 (comfortably hard)
  - Pace: ~20-30 sec/km faster than marathon pace
- 10min cooldown
- **Note:** Key intensity session for the week

###### 🧘 Pilates (12:00-12:30)
**30min Core & Flexibility**
- Core stability work
- Hip mobility
- Spinal articulation
- Breathing exercises
...
- HR: 125-145 bpm
- Power: 110-146W (Z2)
- Keep effort conversational after threshold run
- Indoor or outdoor
...
- **Main set:** 2x10min @ tempo (Z3, 144-175W) with 3min Z2 recovery
- **Cooldown:** 10min Z2 + 7min Z1
- **Total:** 60min
- See workout template for full details

###### 🏃 Run (after 16:30)
**45min Easy Aerobic**
- Easy Z2 recovery run
- HR: 133-145 bpm
- Keep very easy after tempo bike session
...
- **Main set:** 3x2min @ Z5 (204-234W, >108% FTP) with 4min Z1 recovery
- **Cooldown:** 15min Z2 + 5min Z1
- **Total:** 60min
- **Note:** Must complete by 7:00 - indoor trainer required
- See workout template for full details
...
- HR: 125-145 bpm
- Power: 110-146W (Z2)
- Keep effort very low after Thu Z5 intervals
- Onsite gym trainer or similar

##### Sat Nov 29
###### 🏃 Run (10:00-11:30)
**Long Run 90min Z2**
- Easy aerobic long run (~13-14km)
...
- Outdoor preferred for long duration

---

**Weekly Totals:** Swim 2700m (1h30) • Bike 6h45 (160km) • Run 4h00 (32-34km) • Pilates 0h30 • **Total: 12h45**

**Note:** This week follows the Garmin Gran Fondo plan with key intensity sessions - Threshold run (Tue), Tempo bike (Wed), VO2max bike (Thu).

...
|--------------|--------|-------|---------|----------|--------|
| **Sessions** | 2      | 4     | 3       | 2        | 11     |
| **Time**     | 2h05   | 5h30  | 3h20    | 2h       | 12h55  |
| **Distance** | 5200m  | 155km | 28-30km | -        | -      |
...
##### Tue Nov 25
###### 🏃 Run (6:00-7:00)
**60min Run Threshold Intervals**
- 10min warmup (easy Z1-Z2)
- 5x4min @ Z4 threshold (91-95% HRmax)
  - 3min jog recovery (Z1-Z2) between intervals
  - RPE 8/10 (comfortably hard)
  - Pace: ~20-30 sec/km faster than marathon pace
  - Focus: consistent effort, breathing rhythm
- 10min cooldown (easy Z1)
...
###### 🚴 Bike (after 18:30)
**75min Bike Threshold/VO2max Session**
- 15min warmup (progressive Z1→Z2→Z3)
- 5x5min @ Z4-Z5 (185-210W / 95-108% FTP)
  - 4min Z2 recovery between intervals
  - RPE 8-9/10 (very hard)
  - Focus: threshold power, cadence 90-95 rpm
- 15min cooldown Z1-Z2

##### Wed Nov 26
###### 🏃 Run (12:00-12:45)
45min Z2 easy recovery - focus on low effort after Tuesday threshold
...
###### 🏊 Swim (20:00-21:00)
**2800m VO2max Session FIXED**
- 400m warmup (progressive build)
- 8x200m @ T4 (2:03-2:18/100m) on 3:30 rest
  - Target: 2:10-2:15/100m (threshold pace)
  - Focus: maintaining pace across all intervals
- 8x50m @ T5 sprint (<2:03/100m) on 1:15 rest
  - Target: <1:55/50m (maximum effort)
  - Focus: explosive power, race starts
- 200m cooldown (easy)

##### Fri Nov 28
###### 🚴 Bike (6:00-7:00)
60min Z2 easy recovery - critical recovery after Tuesday threshold

###### 🏃 Run (after 17:00)
45min Z2 easy recovery run
...
###### 🚴 Bike (10:00-12:45)
2h45 Z2 long (~70-75km) - 10min warmup, 2h25 steady Z2, 10min cooldown | Nutrition: 60g carbs/hour

##### Sun Nov 30
###### 🚴🏃 Brick Workout
Bike 90min Z2 (~45km) → Quick transition (5min) → Run 45min Z2 off bike (practice race-day transitions)

---

**Weekly Totals:** Swim 5200m (2h05) • Bike 5h30 (155km) • Run 3h20 (28-30km) • Strength 2h • **Total: 12h55**

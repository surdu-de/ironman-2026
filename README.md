...
- **[Performance Data & Tracking](performance-data.md)** - Baseline metrics, race results, testing history
- **[Training Zones](training-zones.md)** - Power, pace, and heart rate zones for all disciplines
- **[Nutrition Strategy](nutrition-strategy.md)** - Daily nutrition, race day fueling, product recommendations
- **[Training Constraints](training-constraints.md)** - Schedule, work/family commitments, equipment

...
**Training Duration:** 30 weeks
**Training Start:** November 10, 2025
**Location:** Hamburg, Germany (Home Advantage!)
...
### Run
- **Z1:** Recovery (< 70% HRmax)
- **Z2:** Easy/Aerobic (70-80% HRmax)
- **Z3:** Tempo (81-90% HRmax)
- **Z4:** Threshold (91-95% HRmax)
- **Z5:** VO2 Max (95-100% HRmax)

### Swim
- **T1:** Recovery/Easy
- **T2:** Aerobic/Endurance
- **T3:** Tempo
- **T4:** Threshold
- **T5:** VO2 Max/Sprint
...
### Training Nutrition
- Carbohydrate intake: 5-7g/kg body weight on moderate days, 7-10g/kg on high-volume days
- Protein: 1.6-2.0g/kg body weight daily
- Hydration: Monitor urine color and weight changes

### Race Day Nutrition Plan
- **Pre-Race:** High carb, low fiber breakfast 3-4 hours before start
- **Swim:** No nutrition needed
- **Bike:** 60-90g carbs/hour
- **Run:** 30-60g carbs/hour
- **Hydration:** 500-750ml/hour with electrolytes

## Progress Tracking

### Key Metrics to Monitor
- **Bike:** FTP (Functional Threshold Power)
- **Run:** Pace at lactate threshold
- **Swim:** CSS (Critical Swim Speed)
- **Overall:** HRV, Resting Heart Rate, Sleep Quality
- **Body Composition:** Weight, body fat percentage

### Testing Schedule
- **Weeks 4, 12, 20, 28:** FTP test, run threshold test, CSS test
- **Weekly:** HRV and resting heart rate monitoring
...
Training and living in Hamburg provides the opportunity to:
- Train on the actual race course
- Familiarize yourself with local weather conditions
- Identify key sections of the bike and run routes
- Build mental preparation by visualizing the course during training
- No travel stress on race week

## Notes

- Adjust training based on life circumstances and recovery markers
- Quality over quantity - better to undertrain slightly than overtrain
- Listen to your body and adjust when needed
- Focus on consistency throughout the 30 weeks
- Enjoy the journey!

---

**Last Updated:** November 10, 2025
**Current Week:** Week 1 - Build Phase
